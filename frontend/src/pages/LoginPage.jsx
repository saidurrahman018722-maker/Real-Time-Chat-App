...
const LoginPage = () => {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-indigo-500 via-purple-500 to-pink-500 p-4 relative overflow-hidden">
      ...
      <div className="card w-full max-w-lg bg-base-100/80 backdrop-blur-xl shadow-2xl z-10 border border-white/10 animate-fade-in-up transition-all duration-300 hover:shadow-purple-500/20 mx-auto">
        <div className="card-body p-6 sm:p-8 md:p-12">
          <div className="flex flex-col items-center mb-6 sm:mb-8 text-center">
            ...
            <h2 className="text-2xl sm:text-3xl font-extrabold tracking-tight text-white drop-shadow-sm">Welcome Back</h2>
            <p className="text-white/80 mt-2 text-xs sm:text-sm font-medium">Enter your credentials to access your account</p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="flex flex-col gap-5">
            ...
            <button 
              type="submit" 
              className="btn w-full mt-6 rounded-xl hover:-translate-y-1 shadow-xl shadow-pink-500/30 transition-all duration-300 font-bold text-lg border-none bg-gradient-to-r from-pink-500 to-rose-500 hover:from-pink-400 hover:to-rose-400 text-white" 
          ...
          <div className="divider mt-8 text-base-content/40 text-sm">New to ChatApp?</div>

          <div className="text-center mt-2">
            <Link to="/register" className="btn btn-outline btn-block rounded-xl border-base-content/20 hover:border-primary hover:bg-primary/5 transition-all">
              Create an account
            </Link>
          </div>
        </div>
